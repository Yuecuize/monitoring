...
use Modules\Page\Repositories\GraphaicRepository;
...
class PublicController extends BasePublicController
{
    ...
    {
        //$gf = new GraphaicRepository();
        //$filename = $gf->fileopen();

        return view('partials.graphic', compact('page'));
    }

    public function generatemultGraphic()
    {
        //$gf = new GraphaicRepository();
        //$filename = $gf->fileopen();

        return view('partials.multgraphic', compact('page'));
    }
